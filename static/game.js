...
document.addEventListener('DOMContentLoaded', function () {
        ...
        startGameBtn.onclick = function () {
            ...
            gameMenu.innerHTML = `
            <img src="/static/image/man_1.png" alt="" style="height: 700px; position: relative; top:100px; left: 500px">
            <img src="/static/image/Rectangle0.png" alt="" style="height: 300px; position: relative; bottom:400px; left:400px">
        ...
        `;
            ...
            document.body.style.backgroundImage = 'url("/static/image/img.png")';
            ...
            animatedText.addEventListener('animationend', function () {
                    ...
                    <img src="/static/image/man_1.png" alt="" style="height: 700px; position: relative; top:100px; left: 500px">
                    <img src="/static/image/Rectangle0.png" alt="" style="height: 300px; position: relative; bottom:400px; left:450px">
                    <div class="animated-text-container">
                ...
                `;
                        ...
                        `;
                                    ...
                                    <div class="info-container" style="box-shadow: 0 4px 8px rgba(44, 43, 43, 0.62); background: rgba(61,61,61,0.65);">
                                        ...
                                        <div class="card-container">
                                            <img src="/static/image/tv.PNG" alt="" style="width: 500px; height:261px; position: relative; bottom: 529px; left:1150px">
                                ...
                                `;
                                                ...
                                                document.body.style.backgroundImage = 'url("/static/image/img_5.png")';
                                                document.body.style.position = 'absolute';
                                                document.body.style.width = '100%';
                                                document.body.style.height = '100%';
                                                ...
                                                internetButton.onclick = function () {
                                                    ...
                                                    `;
                                                        ...
                                                        document.body.style.backgroundImage = 'url("/static/image/gff.png")';
                                                        document.body.style.position = 'absolute';
                                                        document.body.style.width = '100%';
                                                        document.body.style.height = '100%';
                                                ...
                                                `;
                                                                ...
                                                                document.body.style.backgroundImage = 'url("/static/image/img_8.png")';
                                                                document.body.style.position = 'absolute';
                                                                document.body.style.width = '100%';
                                                                document.body.style.height = '100%';
